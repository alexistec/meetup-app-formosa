...
function Ticket({ participant, agenda, ticketId }: TicketProps) {
  ...
  return (
    <div className="relative max-w-[320px] h-[600px] mx-auto" style={{ marginTop:70 }}>
      <div className="absolute inset-0 p-[2px] rounded-[30px] bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 animate-gradient">
          ...
          <div className="relative h-full p-6 flex flex-col justify-between">
            ...
            <div className="space-y-6 flex-1 flex flex-col items-center justify-center">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center p-4 ring-4 ring-purple-500 ring-offset-4 ring-offset-black">
                <QRCodeSVG value={ticketId ? ticketId : 'debatech'} />
              </div>
              
              <div className="text-center space-y-2">
                <h3 className=" font-bold text-white">¡Nos vemos ahí, {participant.name}!</h3>
              </div>
            ...
            <div className="text-center space-y-1">
              <p className="text-xs text-purple-300">Hosted by Macedo Martinez</p>
              <p className="font-mono text-xl text-white tracking-wider">#{randomNumber}</p>
            </div>
          </div>
        </div>
      </div>
